<div class="conatiner">
      <form action="<?php echo base_url() . 'admin/store/create_restaurant'; ?>" method="POST"
            class="form-container mx-auto  shadow-container" id="myForm" style="width:90%"
            ...
            <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : ''; ?>"
                                    placeholder="Add Restaurant Name" value="<?php echo set_value('res_name'); ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php echo (!empty($errorImageUpload)) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group">
                              <label for="v_url">Video</label>
                              <input type="file" name="v_url" id="v_url" class="form-control
                    <?php echo (!empty($errorImageUpload)) ? 'is-invalid' : ''; ?>">
                              <?php echo (!empty($errorImageUpload)) ? $errorImageUpload : ''; ?>
                              <span></span>
                        </div>
...
?>
            ...
            <div class="form-group">
                  ...
                  <input type="text" name="keterangan" id="keterangan" class="form-control
                    <?php echo (form_error('keterangan') != "") ? 'is-invalid' : ''; ?>" placeholder="Add Keterangan"
            ...
            <div class="form-group">
                  ...
                  <input type="text" name="v_nama" id="vnama" class="form-control
                    <?php echo (form_error('v_nama') != "") ? 'is-invalid' : ''; ?>" placeholder="Add Nama Video"
                        value="<?php echo set_value('v_nama'); ?>">

                  <?php echo form_error('v_nama'); ?>
                  <span></span>
            </div>
