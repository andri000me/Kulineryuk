      ...
      <div class="carousel-inner">
            <div class="carousel-item active">
                  ...
                  <div class="carousel-caption text-left">
                        <h1 class="display-2">Cari oleh-oleh?</h1>
                        <h3>Beragam kuliner tersedia untuk anda</h3>
                        <a href="<?php echo base_url() . 'restaurant/index' ?>"
                              class="btn btn-outline-light btn-lg">Order
                              Now</a>
      ...
      <div class="row text-center welcome">
            ...
            <div class="col-12">
                  <p class="lead">The easiest way to your food. Food Ordering System provides fresh delivery
                        with in the 30 minutes and provide free food if order is not on time. So don't wait and start
                        ordering right now!</p>
            </div>
      </div>
</div>
<div class="container-fluid padding">
