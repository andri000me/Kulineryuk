...
class Store extends CI_Controller
{
    ...
    public function create_restaurant()
    {
        ...
        $config['allowed_types'] = 'gif|jpg|png|jpeg|wmv|mp4|avi|mov';
        ...
        // valid video
        $this->form_validation->set_rules('v_nama', 'Nama', 'trim|required');
        $this->form_validation->set_rules('keterangan', 'Keterangan', 'trim|required');

        if ($this->form_validation->run() == true) {

            if (!empty($_FILES['image']['name']['v_url'])) {
                //image is selected
                if ($this->upload->do_upload('image', 'v_url')) {
                    ...
                    $formArray['img']['v_url'] = $data['file_name'];
                    ...
                    $formArray['keterangan'] = $this->input->post('keterangan');
                    $formArray['v_nama'] = $this->input->post('v_nama');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_FILES['image']['name'])) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    $formArray['video'] = $data['file_name'];
                    $formArray['name'] = $this->input->post('res_name');
                    $formArray['email'] = $this->input->post('email');
                    $formArray['phone'] = $this->input->post('phone');
                    $formArray['url'] = $this->input->post('url');
                    ...
                    if (file_exists('./public/uploads/video/thumb/' . $store['v_url'])) {
                        unlink('./public/uploads/video/thumb/' . $store['v_url']);
                    }
